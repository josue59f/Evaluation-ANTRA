...
const Controller = ((model, view) => {
  ...
  // todocontainer.addEventListener("click", (event) => {
  //   state.completedlist.forEach((todo) => {
  //     if (event.target.className === "edit") {
  //       console.log("logic should run");
  //       if (document.getElementById(todo.id).className === "lefttext2") {
  //         document.getElementById(todo.id).className = "lefttext2_hidden";
  //         document.getElementById("toggleinput2").className =
  //           "todolist_completed__show";
  //       } else if (
  //         document.getElementById(todo.id).className === "lefttext2_hidden"
  //       ) {
  //         document.getElementById(todo.id).className = "lefttext2";
  //         document.getElementById("toggleinput2").className =
  //           "todolist_completed";
  //       }
